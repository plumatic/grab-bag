package plumbing;
/* 2013/04/09 borrowed from github.com/mmcgrana/clj-json, 
   as of 8c47203048b3e6ca7e9c8598ccb2a4c9e16654d9 
   At L137, we previously used getNumberValue, which we have
   changed to the more clojure-appropriate getLongValue
*/
    ...
    public void generate(Object obj) throws Exception {
      ...
      if (obj instanceof String) {
        ...
        if (obj instanceof Integer) {
          ...
          Ratio r = (Ratio)obj;
          Double d = new Double(r.doubleValue());
          jg.writeNumber(d);
