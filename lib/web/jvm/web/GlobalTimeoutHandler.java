 ...
 */
public class GlobalTimeoutHandler extends SimpleChannelUpstreamHandler
     ...
     */
    public GlobalTimeoutHandler(Timer timer, int timeoutSeconds) {
     ...
     */
    public GlobalTimeoutHandler(Timer timer, long timeout, TimeUnit unit) {
        if (timer == null) {
    ...
    private final class ReadTimeoutTask implements TimerTask {
	    ...
	    Channels.fireExceptionCaught(ctx, new RuntimeException("Global timeout"));
        }
    }
}
