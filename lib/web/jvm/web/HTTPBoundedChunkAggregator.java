 ...
 */
public class HTTPBoundedChunkAggregator extends SimpleChannelUpstreamHandler {
     ...
     */
    public HTTPBoundedChunkAggregator(int maxContentLength) {
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
        ...
        if (msg instanceof HttpMessage) {
            ...
            this.stoppedEarly = this.maxContentLength >= 0 && content.readableBytes() >= this.maxContentLength;
            if (chunk.isLast() || this.stoppedEarly) {
                this.currentMessage = null;
                ...
                if (this.stoppedEarly) e.getChannel().close();
            } 
        } else {
